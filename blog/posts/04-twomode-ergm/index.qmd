...
Esto refina la tesis de Friedkin [-@friedkinStructuralTheorySocial1998] sobre "consensos superpuestos", sugiriendo que la integración del conocimiento es direccional, con STEM mostrando cohesión interna mientras SHAPE tiende a vínculos interdisciplinares.
...
- Refinamiento de la Teoría de Campos Emergentes: Los resultados sugieren que la teoría de Gondal [-@gondalLocalGlobalStructure2011] necesita ser refinada para incorporar:
...
- Reconsideración de la Relación Disrupción-Estructura: La ausencia de efectos significativos para disrupción y productividad sugiere que el marco de Li et al. [-@liProductiveScientistsAre2024a] y Wu et al. [-@wuLargeTeamsDevelop2019a] necesita ser reconsiderado en el contexto de redes modo-2, donde la relación entre posición estructural e innovación puede operar de manera diferente.
